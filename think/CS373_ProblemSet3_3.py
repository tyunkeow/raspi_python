...
class robot:
    ...
    # sense: 
    #    
    def sense(self, sense_with_noise=1): #do not change the name of this function
        Z = []
...
print "Position computed by particle filter: ", particle_filter(motions, measurements)
...
print 'Position computed by particle filter: ', estimated_position
